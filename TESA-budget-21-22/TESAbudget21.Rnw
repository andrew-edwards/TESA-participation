...
% travel and
registration
costs. Tables 2-5 are summaries for Section
...
Blue_sub <- 1417.15
ICES.MSE_sub <- 1    # NOT SURE YET
PR.Bayesian_sub <- 490 # CHECK
...
funds[funds$Course == "PR.Bayesian", "Subsidy"]  <- PR.Bayesian_sub
funds[funds$Course == "PR.wranling", "Subsidy"]  <- PR.wrangling_sub
